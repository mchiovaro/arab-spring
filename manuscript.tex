...
\begin{figure}
\includegraphics[width=0.9\linewidth,angle=90]{./results/secondary/phoenix/windowed-crqa/target-windowed_all} \caption{Windowed CRQA for social cohesion and event counts from target filtered data.}\label{fig:plot-secondary-phoenix-wcrqa-targ-all}
\end{figure}

\begin{figure}
\includegraphics[width=0.9\linewidth,angle=90]{./results/secondary/phoenix/windowed-crqa/source_target-windowed_all} \caption{Windowed CRQA for social cohesion and event counts from target filtered data.}\label{fig:plot-secondary-phoenix-wcrqa-source-targ-all}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth,angle=90]{./results/secondary/icews/windowed-crqa/target-windowed_all} \caption{Windowed CRQA for social cohesion and event counts from target filtered data.}\label{fig:plot-secondary-icews-wcrqa-targ-all}
\end{figure}

\begin{figure}
\includegraphics[width=0.9\linewidth,angle=90]{./results/secondary/icews/windowed-crqa/source_target-windowed_all} \caption{Windowed CRQA for social cohesion and event counts from target filtered data.}\label{fig:plot-secondary-icews-wcrqa-source-targ-all}
\end{figure}
\end{appendix}
