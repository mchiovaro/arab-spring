...
feeling is known to lead to violence (Collins, 2009; Spaaij, 2014).
While feelings of social connection may lead to violence, increased exposure
to violence can result in feelings of social cohesion. Gilligan, Pasquale, and Samii (2014)
...
following days after the protests (Vicari, 2013). Tweeting was
...
(Turvey, 2018). When analyzed as dynamical systems, many phenomena
...
(for a review, see Fusaroli, Konvalinka, \& Wallot, 2014) and interpersonal synchrony
(Paxton \& Dale, 2017). We argue that the use of nonlinear methods in
...
(WCRQA; Webber Jr \& Zbilut, 2005), we analyzed the dynamics of social
...
max line (maxL). maxL indicates the longest instance of being \enquote{stuck} in a
...
metrics, see Coco and Dale (2018).
...
Using the sample function in base R (R Core Team, 2019), 1000 permuted time series were
...
CRQA was performed using the crqa package (Coco \& Dale, 2018) for R (R Core Team, 2019). We
...
WCRQA was performed using the crqa package (Coco \& Dale, 2018) for R (R Core Team, 2019). Permutation tests
