...
```
```{r plot-RR-targ-all-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of all events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/target-windowed_all_RR.png")

```
```{r plot-DET-targ-all-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of all events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/target-windowed_all_DET.png")

```
```{r plot-RR-targ-pos-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of positive events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/target-windowed_pos_RR.png")

```
```{r plot-DET-targ-pos-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of positive events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/target-windowed_pos_DET.png")

```
```{r plot-RR-targ-neg-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of negative events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/target-windowed_neg_RR.png")

```
```{r plot-DET-targ-neg-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of negative events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/target-windowed_neg_DET.png")

```
```{r plot-RR-source-targ-all-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of all events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/source_target-windowed_all_RR.png")

```
```{r plot-DET-source-targ-all-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of all events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/source_target-windowed_all_DET.png")

```
```{r plot-RR-source-targ-pos-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of positive events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/source_target-windowed_pos_RR.png")

```
```{r plot-DET-source-targ-pos-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of positive events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/source_target-windowed_pos_DET.png")

```
```{r plot-RR-source-targ-neg-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of negative events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/Phoenix/windowed-crqa/source_target-windowed_neg_RR.png")

```
```{r plot-DET-source-targ-neg-secondary-Phoenix, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of negative events from source and target filtered data.', out.width = "40%"}
...
```
```{r plot-RR-targ-all-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of all events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/target-windowed_all_RR.png")

```
```{r plot-DET-targ-all-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of all events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/target-windowed_all_DET.png")

```
```{r plot-RR-targ-pos-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of positive events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/target-windowed_pos_RR.png")

```
```{r plot-DET-targ-pos-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of positive events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/target-windowed_pos_DET.png")

```
```{r plot-RR-targ-neg-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of negative events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/target-windowed_neg_RR.png")

```
```{r plot-DET-targ-neg-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of negative events from target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/target-windowed_neg_DET.png")

```
```{r plot-RR-source-targ-all-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of all events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/source_target-windowed_all_RR.png")

```
```{r plot-DET-source-targ-all-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of all events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/source_target-windowed_all_DET.png")

```
```{r plot-RR-source-targ-pos-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of positive events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/source_target-windowed_pos_RR.png")

```
```{r plot-DET-source-targ-pos-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of positive events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/source_target-windowed_pos_DET.png")

```
```{r plot-RR-source-targ-neg-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of RR for social cohesion and count of negative events from source and target filtered data.', out.width = "40%"}

# call image
knitr::include_graphics("./results/secondary/icews/windowed-crqa/source_target-windowed_neg_RR.png")

```
```{r plot-DET-source-targ-neg-secondary-icews, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = 'Windowed CRQA visualization of DET for social cohesion and count of negative events from source and target filtered data.', out.width = "40%"}
