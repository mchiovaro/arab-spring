...
During this later period, the modal ICEWS event for each day (Figure
...
series (FIX Figure 10). This suggests that the early stretch of above-chance RR
may have been captured in the RR of the all-events analysis, whereas the shorter
stretches were overshadowed by the coupling with negative events. The early
period of above-chance DET in the positive-event analysis aligned with the early
period of above-chance RR, whereas the later stretch of significant DET values
aligns temporally with that of the all-events analysis. It is possible that the
later stretch reflected the decrease in the number of positive events happening
(FIX see Fig. 4), while the relative sparsity of positive events led to an
increase in coupling, with denizens rallying around dwindling bits of hope as
time went on.
...
were more consistent from day to day when considering source events, as might be
expected given that individuals can only participate in a limited number of
events each day. Days that previously had a lower than average number of target
events may now have had a more near-average number of source and target events
because the reduced participation in target events allows for increased
participation and initiation of source events.
...
citizens' actions and reactions that are otherwise suppressed by government
regimes, providing insight into events that may not otherwise be broadcast and
