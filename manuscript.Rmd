...
The corpus of tweets used included `r sum(cohesion_df$n)` Syrian tweets occurring between March 30, 2012 and June 15, 2012. The tweet corpus was scraped from Twitter by [insert search parameters here].
