...
Equation 1 identifies the inverse frequency weighting of each overlapping word ti between two tweets d1 and d2, relative to the word’s frequency in the corpus  D, for all overlapping words t1...k between the two tweets.
...
Equation 2 then calculates the inverse frequency of each word ti  in tweets d1 and d2, relative to the word’s frequency in the corpus D, for all words t1...n that appear in either tweet.
