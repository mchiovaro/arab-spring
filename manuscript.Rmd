...
## Windowed Cross-Recurrence Quantification Analysis
WCRQA was performed using the crqa package [@R-crqa] for R [@R-base]. Permutation tests were conducted for each WCRQA to establish upper and lower 95th and 99th percentiles. In the plots (see Figures #-#), the 95th percentiles are represented by horizontal red lines and the 99th percentiles are represented by horizontal orange lines.
For social cohesion and counts of all and negative events, there appears to be an extended time period where RR and DET were greater than chance, from the 36th through 46th windows. These windows span from May 4th, 2012 to May 28th, 2012. We can see this string of highly violent events reflected in the mode ICEWS event for each day (Figure #).
...
By visual inspection of the recurrence plots (RPs; Figures 3-5), there appears to be a shift in the dynamics of these systems around observation 36, or May 4th, 2012. To further investigate these local dynamics, we performed a sliding window technique known as windowed cross-recurrence quantification analysis (WCRQA).

## Windowed-Recurrence Quantification Analysis
The time period of differing dynamics, from observation 36 through 46, appears to be captured by WCRQA of social cohesion and count of negative events with window size 14 for both RR (Figure 8) and DET (Figure 11). The amount of recurrence and determinism for these periods consistently lie above chance, suggesting that the intensity of negative events coincide with the degree of social cohesion found on Twitter, and that these states carry across multiple days in a way that is different from that of chance. During this time period, Syria underwent the “Siege of Homs” on May 5th, where fleets of tanks were sent into Homs and over 300 individuals were arrested. On May 6th, demonstrators began protesting after Friday prayers, leading to retaliation violence by the Syrian army, leaving sixteen civilians and eleven Syrian army men dead. That day, tens of thousands of individuals marched in an attempt to meet the army peacefully and bring supplies to Deraa, but were refused entrance. This day became known as the “Day of Defiance” or the “Friday of Challenge.” Syria also faced the “Siege of Baniyas” on May 7th, “Siege of Tafas” on May 8th, “Friday of Free Women” on May 13th, “Siege of Talkalakh” on May 14th, the “Israel border demonstrations” on May 15th, “Friday of Azady (freedom)” on May 20th, “Home Protectors’ Friday” on May 27th, and the “Siege of Rastan and Talbiseh” on May 28th.
