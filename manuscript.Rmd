...
```{r num-tweets, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE}

#num_tweets <- read.csv("./data/raw/Syria-social_cohesion.csv")

``` 

The corpus of tweets used included r sum(num_tweets$n) (ADD TICKS) Syrian tweets
