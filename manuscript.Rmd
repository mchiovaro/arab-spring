...
particular state together. The total *number of lines* on the plot (*NRLINE*) 
...
*entropy* (*ENTR*)---which may also be normalized by the total number of lines
(i.e., *normalized entropy*; *rENTR*)---and indicates
