...
analysis of political speech (for example, the language of Margaret Thatcher) 
and non-political speech [@barzilay1999using; @morris1991lexical].

The words that comprise social media posts are the first level at which cohesion
occurs. In Figure \@ref(fig:cohesion-in-tweets), we see four sequential tweets, 
...
are repeated [@graesser2004coh]. These repeated lexical
...
```{r cohesion-in-tweets, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = "Add more informative caption."}
