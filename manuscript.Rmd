...
dir.create("./results/secondary/icews/crqa/source_target", recursive = TRUE)
dir.create("./results/secondary/icews/crqa/target", recursive = TRUE)
dir.create("./results/secondary/icews/windowed-crqa/source_target", recursive = TRUE)
dir.create("./results/secondary/icews/windowed-crqa/target", recursive = TRUE)
dir.create("./results/secondary/phoenix/crqa/source_target", recursive = TRUE)
dir.create("./results/secondary/phoenix/crqa/target", recursive = TRUE)
dir.create("./results/secondary/phoenix/windowed-crqa/source_target", recursive = TRUE)
dir.create("./results/secondary/phoenix/windowed-crqa/target", recursive = TRUE)
...
```{r primary-table-phoenix-source-target, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE}
