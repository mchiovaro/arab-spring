######## Windowed Cross-Recurrence Quantification Analysis (ICEWS) ########
#
...
# save them
ggsave(filename = "./results/secondary/icews/windowed-crqa/source_target-windowed_all.png",
...
# save them
ggsave(filename = "./results/secondary/icews/windowed-crqa/target-windowed_all.png",
