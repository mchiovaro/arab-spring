...
shuffled_full <- read.csv("./data/formatted/secondary/icews/shuffled_data_full.csv")
...
# read in CRPs
crp_1 <- readPNG('./results/secondary/icews/crqa/source_target-rp-all_events.png')
crp_2 <- readPNG('./results/secondary/icews/crqa/source_target-rp-pos_events.png')
crp_3 <- readPNG('./results/secondary/icews/crqa/source_target-rp-neg_events.png')

# join images and save
png("./results/secondary/icews/crqa/source_target-rp-joined.png", width=720, height=325)
...
# read in CRPs
crp_1 <- readPNG('./results/secondary/icews/crqa/target-rp-all_events.png')
crp_2 <- readPNG('./results/secondary/icews/crqa/target-rp-pos_events.png')
crp_3 <- readPNG('./results/secondary/icews/crqa/target-rp-neg_events.png')

# join images and save
png("./results/secondary/icews/crqa/target-rp-joined.png", width=720, height=325)
grid.arrange(rasterGrob(crp_1),rasterGrob(crp_2), rasterGrob(crp_3), ncol=3)
dev.off()
