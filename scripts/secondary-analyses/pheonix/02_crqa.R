######## Cross-Recurrence Quantification Analysis (Pheonix) ########
#
...
shuffled_full <- read.csv("./data/formatted/secondary/pheonix/shuffled_data_full.csv")
...
write.table(rqa_results_all_source_target,'./results/secondary/pheonix/crqa/source_target/crqa_results-all_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/pheonix/crqa/source_target/rp-all_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
...
write.table(rqa_results_pos_source_target,'./results/secondary/pheonix/crqa/source_target/crqa_results-pos_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/pheonix/crqa/source_target/rp-pos_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
...
write.table(rqa_results_neg_source_target,'./results/secondary/pheonix/crqa/source_target/crqa_results-neg_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/pheonix/crqa/source_target/rp-neg_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
...
write.table(rqa_results_all_target,'./results/secondary/pheonix/crqa/target/crqa_results-all_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/pheonix/crqa/target/rp-all_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
           labely = "Count of all events", 
           cols = "blue", 
...
write.table(rqa_results_pos_target,'./results/secondary/pheonix/crqa/target/crqa_results-pos_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/pheonix/crqa/target/rp-pos_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
           labely = "Count of positive events", 
           cols = "blue", 
...
write.table(rqa_results_neg_target,'./results/secondary/pheonix/crqa/target/crqa_results-neg_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/pheonix/crqa/target/rp-neg_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
           labely = "Count of negative events", 
           cols = "blue", 
...
# write to file
write.table(significance_all_source_target,'./results/secondary/pheonix/crqa/source_target/metric_signif_all.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_pos_source_target,'./results/secondary/pheonix/crqa/source_target/metric_signif_pos.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_neg_source_target,'./results/secondary/pheonix/crqa/source_target/metric_signif_neg.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_all_target,'./results/secondary/pheonix/crqa/target/metric_signif_all.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_pos_target,'./results/secondary/pheonix/crqa/target/metric_signif_pos.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_neg_target,'./results/secondary/pheonix/crqa/target/metric_signif_neg.csv',
            sep=",", row.names=FALSE)
