######## Cross-Recurrence Quantification Analysis (Terrier) ########
#
...
shuffled_full <- read.csv("./data/formatted/secondary/terrier/shuffled_data_full.csv")
...
write.table(rqa_results_all_source_target,'./results/secondary/terrier/crqa/source_target-crqa_results-all_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/terrier/crqa/source_target-rp-all_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
...
write.table(rqa_results_pos_source_target,'./results/secondary/terrier/crqa/source_target-crqa_results-pos_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/terrier/crqa/source_target-rp-pos_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
...
write.table(rqa_results_neg_source_target,'./results/secondary/terrier/crqa/source_target-crqa_results-neg_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/terrier/crqa/source_target-rp-neg_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
...
# read in CRPs
crp_1 <- readPNG('./results/secondary/terrier/crqa/source_target-rp-all_events.png')
crp_2 <- readPNG('./results/secondary/terrier/crqa/source_target-rp-pos_events.png')
crp_3 <- readPNG('./results/secondary/terrier/crqa/source_target-rp-neg_events.png')

# join images and save
png("./results/secondary/terrier/crqa/source_target-rp-joined.png", width=720, height=325)
...
write.table(rqa_results_all_target,'./results/secondary/terrier/crqa/target-crqa_results-all_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/terrier/crqa/target-rp-all_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
           labely = "Count of all events", 
           cols = all_event_color, 
...
write.table(rqa_results_pos_target,'./results/secondary/terrier/crqa/target-crqa_results-pos_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/terrier/crqa/target-rp-pos_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
           labely = "Count of positive events", 
           cols = positive_event_color, 
...
write.table(rqa_results_neg_target,'./results/secondary/terrier/crqa/target-crqa_results-neg_events.csv',
            sep=",", row.names=FALSE)

# build the CRP using 'crqa' package function: plotRP
png("./results/secondary/terrier/crqa/target-rp-neg_events.png", width = 4, height = 4, units = 'in', res = 300)
par = list(unit = 2, 
           labelx = "Social cohesion", 
           labely = "Count of negative events", 
           cols = negative_event_color, 
...
# read in CRPs
crp_1 <- readPNG('./results/secondary/terrier/crqa/target-rp-all_events.png')
crp_2 <- readPNG('./results/secondary/terrier/crqa/target-rp-pos_events.png')
crp_3 <- readPNG('./results/secondary/terrier/crqa/target-rp-neg_events.png')

# join images and save
png("./results/secondary/terrier/crqa/target-rp-joined.png", width=720, height=325)
grid.arrange(rasterGrob(crp_1),rasterGrob(crp_2), rasterGrob(crp_3), ncol=3)
dev.off()
...
# write to file
write.table(significance_all_source_target,'./results/secondary/terrier/crqa/source_target-metric_signif_all.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_pos_source_target,'./results/secondary/terrier/crqa/source_target-metric_signif_pos.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_neg_source_target,'./results/secondary/terrier/crqa/source_target-metric_signif_neg.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_all_target,'./results/secondary/terrier/crqa/target-metric_signif_all.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_pos_target,'./results/secondary/terrier/crqa/target-metric_signif_pos.csv',
            sep=",", row.names=FALSE)
...
# write to file
write.table(significance_neg_target,'./results/secondary/terrier/crqa/target-metric_signif_neg.csv',
            sep=",", row.names=FALSE)
